    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-auto pt-4 flex gap-2">
          <button
            className="flex-1 min-w-0 flex items-center justify-center gap-1.5 rounded-xl bg-mad-dark-hover border border-mad-border px-3 py-2.5 text-xs sm:text-sm font-medium text-mad-text-primary transition-all hover:bg-mad-cyan/10 hover:border-mad-cyan/30 hover:text-mad-cyan"
            onClick={(e) => {
              e.stopPropagation();
              onClick?.();
            }}
          ...
          <a
            ...
            className="whatsapp-btn flex items-center justify-center shrink-0 rounded-xl px-3 py-2.5 font-semibold text-white transition-all hover:scale-105"
