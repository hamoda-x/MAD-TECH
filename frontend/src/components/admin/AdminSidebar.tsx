  ...
  return (
    <>
      ...
      >
        ...
        <div className="shrink-0 border-b border-mad-border p-4">
          <div className="flex items-center justify-between">
            ...
            <div>
              <h1 className="text-lg font-bold text-mad-text">MAD_TECH</h1>
              <p className="text-xs text-mad-muted">{lang === "ar" ? "لوحة التحكم" : "Admin Panel"}</p>
            </div>
          </Link>
            {/* Mobile close button */}
            <button
              onClick={onClose}
              className="lg:hidden flex h-8 w-8 items-center justify-center rounded-lg text-mad-muted hover:bg-mad-bg hover:text-mad-text transition-colors"
            >
        ...
        <div className="shrink-0 border-t border-mad-border p-3 space-y-1">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-mad-muted transition-all duration-200 hover:bg-mad-bg hover:text-mad-text"
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div className="flex items-center gap-3 rounded-xl px-4 py-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-medium text-mad-text">Admin</p>
            </div>
            <button
      ...
      <Modal
        ...
        title={lang === "ar" ? "تأكيد تسجيل الخروج" : "Confirm Logout"}
        size="md"
      >
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-mad-muted">{lang === "ar" ? "هل أنت متأكد من تسجيل الخروج؟" : "Are you sure you want to logout?"}</p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex flex-1 items-center justify-center rounded-xl border border-mad-border px-4 py-3 text-sm font-medium text-mad-text transition-colors hover:bg-mad-bg"
            >
